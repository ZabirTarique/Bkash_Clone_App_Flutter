            ...
            children: [
              ...
              Card(color: Colors.white, elevation: 2, child: Column(children: [
                ...
                Padding(padding: const EdgeInsets.fromLTRB(12.0, 12.0, 12.0, 16.0), child: TextField(
                  ...
                  decoration: const InputDecoration.collapsed(hintText: "Tap to add a note", hintStyle: AppTheme.nbodyText,),
                ),),
                Container(width: double.infinity, height: 1, color: Colors.black12,),
                Padding(padding: const EdgeInsets.fromLTRB(12, 24, 12, 24), child: Row(children: [
                  ...
                  Expanded(child: TextField(
                    ...
                    decoration: const InputDecoration.collapsed(hintText: "Enter PIN", hintStyle: AppTheme.pinHintText,),
                  )),
                  InkWell(onTap: () {
