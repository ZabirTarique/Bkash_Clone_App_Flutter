...
import 'package:bkash_clone_app_flutter/pages/pin_page.dart';
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              Card(color: Colors.white, elevation: 2, child: Column(children: [
                ...
                Padding(padding: const EdgeInsets.fromLTRB(24, 12, 12, 12), child: Row(children: [
                  ...
                  Expanded(child: TextField(
                    ...
                    decoration: const InputDecoration.collapsed(hintText: "৳0", hintStyle: AppTheme.amtHintText,),
                  )),
                  InkWell(onTap: () {
                    Navigator.push(
                      context,
              ...
              //priyo list
              Card(color: Colors.white, elevation: 2, child: Column(children: [
                Padding(padding: const EdgeInsets.fromLTRB(24, 4, 4, 4), child: Row(children: [Image.asset("assets/priyo.jpg", height: 40, width: 40,) , const Expanded(child: Padding(padding: EdgeInsets.fromLTRB(12,8,12,4), child: Text("Add this number to my Priyo list", style: AppTheme.priyoText,),))],),),
              ],),),
            ],
          ),
        )
