...
class PaymentContactsWidget extends StatelessWidget {
  const PaymentContactsWidget({
      ...
      body: Card(color: Colors.white, elevation: 4, margin: const EdgeInsets.all(12), child: Column(children: [
        Expanded(child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // else
              if(index == 0){
              return const Row(children: [Expanded(child: Padding(padding: EdgeInsets.fromLTRB(12, 4, 0, 4),child: Text("Recent", style: AppTheme.ntitleText,),))],);
            }
            else if(index == 3){
              return const Row(children: [Expanded(child: Padding(padding: EdgeInsets.fromLTRB(12, 4, 0, 4),child: Text("Saved Payments", style: AppTheme.ntitleText,),))],);
            }
            else {
