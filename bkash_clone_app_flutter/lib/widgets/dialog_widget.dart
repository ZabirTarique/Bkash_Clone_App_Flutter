      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: InkWell(onTap: () {Navigator.pop(context);}, child: const SizedBox(
        ...
        Expanded(child: Container(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
              const Row(children: [Padding(padding: EdgeInsets.fromLTRB(12,8,4,24), child: Text("Confirm to ", style: AppTheme.dialogconfirmText,),), Expanded(child: Padding(padding: EdgeInsets.fromLTRB(0,8,12,24), child: Text("Send Money", style: AppTheme.dialogconfirmTextBold,),))],),
              ...
              Padding(padding: const EdgeInsets.all(12.0), child: Row(children: [Image.asset("assets/priyo.jpg", height: 40, width: 40,) , const Expanded(child: Padding(padding: EdgeInsets.fromLTRB(12,8,12,4), child: Text("You can send money free up to 25,000 Tk. monthly by adding Priyo number.", style: AppTheme.pinHintText,),))],),)
            ],),
          ),
        )),
        AnimatedButton(
